...
export default function LocaleSwitcher() {
    ...
    return (
        <div className="h-full relative flex justify-center mb-1 items-center gap-2  text-white select-none cursor-pointer" onClick={switchMenu}>
            ...
            <svg style={{ cursor: "pointer" }} width="10" height="6" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="m1 1 4 4 4-4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>
            <div onPointerLeave={hideMenu} className={`flex  flex-col absolute justify-items-start top-7 items-stretch flagdrop cursor-default ${dropVisible ? styles.visible : styles.hidden}`}  >
                {
